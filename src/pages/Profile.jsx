    ...
    <div className="w-full h-screen flex flex-col items-center bg-gray-100 p-4">
      <div className="w-full h-1/2 bg-center bg-cover relative">
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col items-center justify-center bg-black bg-opacity-50 text-white p-4">
          <p className="mb-4 font-semibold text-info text-2xl">
            Account Information:
          </p>
          <div className="mb-4">
            <img
      ...
      {showAutomobile && (
        <div className="w-full bg-white p-4 mt-4 shadow-lg rounded-lg text-info ">
           <Cls/>
        </div>
      )}

      {showHome && (
        <div className="w-full bg-white p-4 mt-4 shadow-lg rounded-lg text-info m-auto">
      ...
      {!showAutomobile && !showHome && !showFamily && (
        <div className="w-full h-1/2 bg-center bg-cover relative flex justify-center items-center gap-4">
          <div className="bg-white rounded-lg p-6 w-80 h-72 text-gray-800 shadow-xl">
