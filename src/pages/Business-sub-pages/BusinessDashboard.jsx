...
>>>>>>> 7aed83cd8acfa106516211a14069d7b4378a461f

        <div className="mb-8">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Top 3 Daromadli Bizneslar</h2>
                ...
                {interpolatedStyle => (
                  ...
                  >
                    ...
                    <CardContent className="pt-6">
                      ...
                      <p className="text-sm text-gray-500">Umumiy daromadning {((business.income / totalTopIncome) * 100).toFixed(1)}%</p>
                    </CardContent>
                  </Card>
                )}
              </Motion>
        ...
        <div className="mb-8 bg-white rounded-2xl shadow-xl p-6 sm:p-10">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Bizneslar Daromadi Taqqoslama</h2>
        ...
        <div className="mb-8 bg-white rounded-2xl shadow-xl p-6 sm:p-10">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Biznes Ko'rsatkichlari</h2>
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            <Card>
              <CardContent className="flex flex-col items-center pt-6">
                <DollarSign className="w-8 h-8 mb-4 text-green-500" />
                <p className="text-xl font-semibold">{user.totalIncome.toLocaleString()} so'm</p>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-10 relative">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Barcha Bizneslaringiz</h2>
          <button 
            onClick={goToPrev}
            ...
            {allBusinesses.map((business) => (
              <div key={business.id} className="px-2">
                <Card className="h-full">
                  ...
                  <CardContent className="pt-6">
                    <div className="text-xl font-bold mb-2">{business.income.toLocaleString()} so'm</div>
