...
export default function BusinessDashboard() {
  ...
  const user = {
    ...
    avatar:
      "https://yt3.googleusercontent.com/ytc/AIdro_kQ0De5HtsKcFUOAxSII-Roa7VwT4N4PJOgNNrGd8lsyjk=s900-c-k-c0x00ffffff-no-rj",
  ...
  const totalTopIncome = topBusinesses.reduce(
        ...
        <div className="mb-8">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            {topBusinesses.map((business, index) => (
              <Motion
                key={business.id}
                style={{ scale: spring(hoveredBusiness === index ? 1.05 : 1) }}
              >
                {(interpolatedStyle) => (
                  <Card
                  ...
                  >
                    <CardHeader
                      className={`bg-gradient-to-r ${business.color} text-white`}
                    >
